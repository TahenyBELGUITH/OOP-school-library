...
- Clone this repo <https://github.com/TahenyBELGUITH/OOP-school-library.git>

  ```bash
  git clone https://github.com/TahenyBELGUITH/OOP-school-library.git
  ```
...
- Next, run `ruby OOP-school-library.rb` which will run the app in the development mode.
